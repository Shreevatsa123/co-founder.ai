...
// --- NEW Dynamic Chart for Strategic Insights ---
export const DynamicChart: React.FC<{ metric: DomainMetric }> = ({ metric }) => {
    ...
    return (
      <div className="grid grid-cols-2 gap-4">
        {metric.data.map((item, i) => (
          <div key={i} className="bg-slate-50 border border-slate-200 rounded-lg p-4 flex flex-col items-center justify-center text-center">
  ...
  // Bar or Line (Visualized as Bars for simplicity in CSS)
